    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            var Properties = new List<Property>
            {
                ...
                new Property {ListerId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyTypeId = 1, CityId = 9, CountyId = 16, StateId = 14, Address = "987 Place Pl.", Zipcode = "74135", StatusId = 1, Title = "Great Wedding Spot", Description = "Perfect for medium wedding ceremonies on the beach", LastUpdated = DateTime.Now.AddDays(5), GuestSharing = false, GuestMax = 6, BedroomNum = 3, BathroomNum = 1, ImageId = 14, BasePrice = 47.21f },
                new Property {ListerId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyTypeId = 1, CityId = 2, CountyId = 7, StateId = 17, Address = "741 Long Ave.", Zipcode = "31588", StatusId = 1, Title = "Your Mom's House", Description = "Stocked with fresh cookies!", LastUpdated = DateTime.Now.AddDays(-7), GuestSharing = false, GuestMax = 2, BedroomNum = 1, BathroomNum = 0, ImageId = 15, BasePrice = 63.24f },
                new Property {ListerId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyTypeId = 3, CityId = 20, CountyId = 6, StateId = 3, Address = "852 West St.", Zipcode = "45321", StatusId = 3, Title = "Where Dreams Come True", Description = "It's just a room with a bed", LastUpdated = DateTime.Now.AddDays(-20), GuestSharing = true, GuestMax = 15, BedroomNum = 5, BathroomNum = 3, ImageId = 16, BasePrice = 96.25f },
                new Property {ListerId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyTypeId = 6, CityId = 2, CountyId = 19, StateId = 1, Address = "963 Mother Rd.", Zipcode = "98265", StatusId = 2, Title = "Fox Garden", Description = "Come play with some furry friends!", LastUpdated = DateTime.Now.AddDays(0), GuestSharing = true, GuestMax = 5, BedroomNum = 2, BathroomNum = 1, ImageId = 17, BasePrice = 203.69f },
                new Property {ListerId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyTypeId = 5, CityId = 4, CountyId = 10, StateId = 19, Address = "951 Wall Ave.", Zipcode = "12783", StatusId = 1, Title = "World's Largest Potato", Description = "This is your chance to sleep INSIDE the world's largest potato! It has been hollowed out to make space for a living area. Don't miss this once in a lifetime experience!", LastUpdated = DateTime.Now.AddDays(-1500), GuestSharing = false, GuestMax = 1, BedroomNum = 1, BathroomNum = 0, ImageId = 18, BasePrice = 50.00f }
            };
            ...
            {
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 2, Checkin = DateTime.Now.Date.AddDays(0), Checkout = DateTime.Now.Date.AddDays(5), Tax = 16.23f, TotalPrice = 133.56f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 1, Checkin = DateTime.Now.Date.AddDays(4), Checkout = DateTime.Now.Date.AddDays(10), Tax = 14.74f, TotalPrice = 56.17f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 3, Checkin = DateTime.Now.Date.AddDays(7), Checkout = DateTime.Now.Date.AddDays(10), Tax = 25.98f, TotalPrice = 384.18f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 13, Checkin = DateTime.Now.Date.AddDays(30), Checkout = DateTime.Now.Date.AddDays(33), Tax = 62.15f, TotalPrice = 5612.04f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 7, Checkin = DateTime.Now.Date.AddDays(-5), Checkout = DateTime.Now.Date.AddDays(0), Tax = 85.21f, TotalPrice = 231.25f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 12, Checkin = DateTime.Now.Date.AddDays(-30), Checkout = DateTime.Now.Date.AddDays(-26), Tax = 12.36f, TotalPrice = 84.12f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 8, Checkin = DateTime.Now.Date.AddDays(-15), Checkout = DateTime.Now.Date.AddDays(-11), Tax = 84.15f, TotalPrice = 163.20f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 14, Checkin = DateTime.Now.Date.AddDays(-3), Checkout = DateTime.Now.Date.AddDays(1), Tax = 95.21f, TotalPrice = 746.18f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 10, Checkin = DateTime.Now.Date.AddDays(4), Checkout = DateTime.Now.Date.AddDays(9), Tax = 48.21f, TotalPrice = 62.30f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 9, Checkin = DateTime.Now.Date.AddDays(1), Checkout = DateTime.Now.Date.AddDays(4), Tax = 5.81f, TotalPrice = 17.21f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 5, Checkin = DateTime.Now.Date.AddDays(10), Checkout = DateTime.Now.Date.AddDays(14), Tax = 17.23f, TotalPrice = 56.34f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 15, Checkin = DateTime.Now.Date.AddDays(-25), Checkout = DateTime.Now.Date.AddDays(-21), Tax = 15.84f, TotalPrice = 32.76f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 2, Checkin = DateTime.Now.Date.AddDays(6), Checkout = DateTime.Now.Date.AddDays(8), Tax = 14.43f, TotalPrice = 53.18f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).First().Id, PropertyId = 11, Checkin = DateTime.Now.Date.AddDays(2), Checkout = DateTime.Now.Date.AddDays(7), Tax = 71.32f, TotalPrice = 203.52f, IsConfirmed = true },
                new Booking { GuestId = _db.ApplicationUsers.OrderBy(user => user.SignupDate).Last().Id, PropertyId = 6, Checkin = DateTime.Now.Date.AddDays(0), Checkout = DateTime.Now.Date.AddDays(4), Tax = 25.81f, TotalPrice = 84.27f, IsConfirmed = true }
