        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ListerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PropertyTypeId = table.Column<int>(type: "int", nullable: true),
                    LocationId = table.Column<int>(type: "int", nullable: true),
                    StatusId = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GuestSharing = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CleaningFee = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PropertyBedConfigurations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyBedConfigurations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyNightlyPrices", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyBedConfigurations_BedConfigurationId",
                table: "PropertyBedConfigurations",
                column: "BedConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyBedConfigurations_PropertyId",
                table: "PropertyBedConfigurations",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyDiscounts_DiscountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyNightlyPrices_PropertyId",
                table: "PropertyNightlyPrices",
                column: "PropertyId");
